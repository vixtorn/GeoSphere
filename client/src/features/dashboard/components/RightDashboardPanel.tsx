...
import { getFavoriteLocations } from "../../../services/api/favoriteLocationsApi";
import type {
  CurrentWeatherDto,
  FavoriteLocationDto,
  ...
  return (
    <>
      ...
      <DashboardCard
        icon={<MapPinned size={22} />}
        title="Terrain"
        subtitle="Mock geospatial classification"
      >
        <div className="mt-4 grid grid-cols-2 gap-3">
...
function SavedLocationsTab({
  ...
  if (favoriteLocations.length === 0) {
    return <EmptyCard message="No saved locations yet." />;
  }
  ...
  return (
    <DashboardCard
      ...
      subtitle="Fetched from .NET backend mock endpoint."
    >
